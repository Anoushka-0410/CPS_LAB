    ...
    <div className="human-systems-wrapper rf-card-wrapper">
      ...
      <div className="human-content rf-card-content">
        <div className="human-section-1 rf-card-section1">
          ...
          <div className="section1-content">{parse(about_hs)}</div>
          <div className="line-divider"></div>
        </div>
        <div className="human-section-2 rf-card-section2">
          Human Cyber Physical Systems (HCPS) are emerging to identify
          principles for the human-centered design of future CPS and to break
          away the limitations of Cyber Physical. These systems enable the
          development of social systems by placing humans inside the control
          loop.
        </div>
      </div>
    </div>
